...
angular.module('starter', [ 'starter.controllers', 'ionic', 'ionic-material', 'ionMdInput', 'starter.services', 'highcharts-ng'])
...
.config(function($stateProvider, $urlRouterProvider, $ionicConfigProvider, $compileProvider) {
    ...
    */
    ...
    .state('app.jepret', {
        ...
        views: {
            'menuContent': {
                templateUrl: 'templates/jepret.html',
    ...
    .state('app.gallerypemda', {
        url: '/gallery',
        views: {
            'menuContent': {
                templateUrl: 'templates/gallerypemda.html',
    ...
    .state('app.gakin', {
        ...
        views: {
            'menuContent': {
                templateUrl: 'templates/gakin.html',
                controller: 'GalleryCtrl'
            },
            'fabContent': {
                // template: '<button id="fab-gallery" class="button button-fab button-fab-top-right expanded button-energized-900 drop"><i class="icon ion-heart"></i></button>',
    ...
    .state('app.login', {
        ...
        views: {
            'menuContent': {
                templateUrl: 'templates/logindulu.html',
